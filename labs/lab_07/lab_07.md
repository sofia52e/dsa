...
29. Приведите примеры реальных задач, которые можно смоделировать с помощью графов и решить описанными алгоритмами (например, картография, маршрутизация в сетях, анализ социальных сетей).
